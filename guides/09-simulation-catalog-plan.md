...
5. Concluido: expandir `Oscilacoes e Ondas > Ondas mecanicas` a partir de corda viajante, superposicao/interferencia e ondas estacionarias como `ready` apos aprovacao manual, mantendo PixiJS como avaliacao opcional para densidade 2D.
