...
5. Concluido: expandir `Oscilacoes e Ondas > Ondas mecanicas` com corda viajante, onda longitudinal em mola, superposicao/interferencia e ondas estacionarias como `ready` apos aprovacao manual; a onda longitudinal cobre propagacao com compressao/rarefacao em uma mola diagonal, mantendo PixiJS como avaliacao opcional para densidade 2D.
