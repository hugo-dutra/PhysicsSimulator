...
- A segunda simulacao mecanica e o primeiro lote de Cinematica validam se o mesmo shell, os mesmos blocos de dados e o helper renderer-first reduzem o custo de adicionar novos modelos.
