...
- Definir se, apos validar manualmente as simulacoes mecanicas em `analysis`, a proxima fatia deve ir para `Oscilacoes e Ondas` propriamente dita ou revisar/promover mecanica restante para `ready`.
