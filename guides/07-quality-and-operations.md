...
- Em `Curvatura gravitacional em malha 3D`, o smoke visual deve confirmar um volume de 12 x 12 x 12 cubos interligados por arestas X/Y/Z sem diagonais, camera capaz de revelar profundidade, varios vertices coincidindo no centro de cada massa e transicao suave fora do nucleo. Os pontos intermediarios devem suavizar as linhas sem alterar a quantidade de cubos. Aumentar a massa deve ampliar intensidade, nucleo, distancia perceptivel e regiao vermelha do gradiente; zerar a intensidade deve restaurar a grade ortogonal teal sem mudar a orbita. Confirmar tambem taxa de quadros utilizavel e ausencia de erro no console.
