...
- O usuario consegue abrir `Oscilacoes e Ondas > Ondas mecanicas > Onda em corda`, `Superposicao e interferencia` e `Ondas estacionarias` pela sidebar como simulacoes em analise, com cena, controles, graficos, tabela, formulas e teoria sincronizados.
