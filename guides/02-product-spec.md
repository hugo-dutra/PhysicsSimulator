...
A sidebar deve ser organizada como arvore compacta: area principal expansivel, subarea expansivel e simulacoes como folhas marcadas por status. Subareas que contenham ao menos uma simulacao `analysis` iniciam abertas para destacar o que precisa de teste; subareas que contenham apenas simulacoes `ready` ou `planned` iniciam recolhidas. O fixture local de catalogo deve conter todas as simulacoes planejadas em `09-simulation-catalog-plan.md`; no estado atual, pendulo simples, massa-mola vertical, MRU, MUV/queda livre, lancamento obliquo, MCU, plano inclinado com atrito, Maquina de Atwood, Forca centripeta em curva, Trabalho e energia em trilho, Colisoes 1D e 2D, Equilibrio de particula e Torque/alavancas/centro de massa aparecem como `ready`, enquanto Rotacao de corpo rigido, Rolamento sem escorregamento, Campo gravitacional e orbitas, Hidrostatica e empuxo e Continuidade e Bernoulli aparecem como `analysis`.
...
- Rotacao de corpo rigido: inercia base do rotor, distancia radial da massa movel, torque aplicado, velocidade angular inicial de referencia, angulo inicial e amortecimento angular.
...
- Campo gravitacional e orbitas: campo `GM/r^2`, equacao vis-viva, forca central e energia orbital.
- Hidrostatica e empuxo: pressao `rho g h`, principio de Arquimedes e criterio de flutuacao por densidades.
...
- Campo gravitacional e orbitas: massa central, raio de periastro, excentricidade, massa do satelite e angulo inicial.
- Hidrostatica e empuxo: densidade do fluido, densidade do corpo, volume do corpo, profundidade e gravidade.
...
- Rotacao de corpo rigido: `I = I_base + m r^2`, `L = I omega`, `tau = I alpha`, cinamatica angular, amortecimento angular e energia rotacional.
