...
- O usuario consegue abrir `Oscilacoes e Ondas > Som > Batimentos` e `Efeito Doppler` pela sidebar como simulacoes em analise, com campo volumetrico 3D de pontinhos de pressao, fonte/probe ou fonte/observador, graficos, tabela, formulas e teoria sincronizados.
