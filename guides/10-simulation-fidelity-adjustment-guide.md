...
- O alfa das linhas volumetricas usa a intensidade desse mesmo heatmap: o controle define o teto perto das massas e, longe delas, a opacidade decai suavemente para um piso visual baixo e nao nulo. Alfa configurado em zero continua ocultando toda a malha; esse mapeamento nao altera geometria nem samples.
- Um feixe didatico pode nascer sobre uma linha-base e usar os mesmos pocos visuais, mas sua direcao deve ser acumulada passo a passo: longe das massas permanece praticamente reto; perto do nucleo recebe incrementos transversais; depois que a influencia cai, continua pela tangente adquirida e nao retorna a linha-base. Toggle, plano, offsets e progresso `0..100%` pertencem apenas ao renderer e nao podem alterar samples. A teoria deve deixar explicito que isso nao resolve uma geodesica nula relativistica nem fornece angulo quantitativo de lente gravitacional.
